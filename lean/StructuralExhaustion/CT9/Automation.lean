...
def capabilityContract : Core.CapabilityContract where
  ...
  derivedOperations := ["CT9.fibre", "CT9.fibre_nodup", "CT9.totalCapacity",
    ...
    "CT9.run_terminal_bounded_of_bounded",
    "CT9.run_trace_bounded_of_bounded",
    "CT9.fibreCount_le_one_of_label_injective_on_items",
    "CT9.fibreCount_eq_zero_of_label_absent",
    "CT9.cardinality_le_totalCapacity_of_bounded",
    "CT9.cardinality_le_totalCapacity_of_label_injective_on_items",
    ...
    "CT9.BoundedRun", "CT9.runBoundedOfBounded",
