...
private theorem p13MultiScaleRows_featureAudit_08_00 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 8
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_01 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_02 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_03 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_04 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_05 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_06 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_07 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_08 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_09 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_10 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_11 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_12 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_13 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_14 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_15 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_16 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_17 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_18 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_19 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_20 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_21 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_22 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_23 :
    ∀ offset : Fin 16,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_08_24 :
    ∀ offset : Fin 15,
      row 8
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_08 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 8 source = p13FeatureCompatibilityRow 8 source :=
      p13MultiScaleRows_featureAudit_08 source
    _ = semanticRow 8 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 8 source
