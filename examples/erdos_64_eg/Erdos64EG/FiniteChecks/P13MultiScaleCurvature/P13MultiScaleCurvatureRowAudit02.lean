...
private theorem p13MultiScaleRows_featureAudit_02_00 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 2
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_01 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_02 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_03 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_04 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_05 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_06 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_07 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_08 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_09 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_10 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_11 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_12 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_13 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_14 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_15 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_16 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_17 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_18 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_19 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_20 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_21 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_22 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_23 :
    ∀ offset : Fin 16,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_02_24 :
    ∀ offset : Fin 15,
      row 2
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_02 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 2 source = p13FeatureCompatibilityRow 2 source :=
      p13MultiScaleRows_featureAudit_02 source
    _ = semanticRow 2 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 2 source
