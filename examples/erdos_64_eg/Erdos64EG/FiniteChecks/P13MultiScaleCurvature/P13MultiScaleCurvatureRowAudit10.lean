...
private theorem p13MultiScaleRows_featureAudit_10_00 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 10
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_01 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_02 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_03 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_04 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_05 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_06 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_07 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_08 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_09 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_10 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_11 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_12 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_13 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_14 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_15 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_16 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_17 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_18 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_19 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_20 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_21 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_22 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_23 :
    ∀ offset : Fin 16,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_10_24 :
    ∀ offset : Fin 15,
      row 10
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_10 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 10 source = p13FeatureCompatibilityRow 10 source :=
      p13MultiScaleRows_featureAudit_10 source
    _ = semanticRow 10 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 10 source
