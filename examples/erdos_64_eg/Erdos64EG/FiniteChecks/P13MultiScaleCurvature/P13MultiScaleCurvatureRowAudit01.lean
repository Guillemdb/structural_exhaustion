...
private theorem p13MultiScaleRows_featureAudit_01_00 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 1
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_01 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_02 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_03 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_04 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_05 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_06 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_07 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_08 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_09 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_10 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_11 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_12 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_13 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_14 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_15 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_16 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_17 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_18 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_19 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_20 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_21 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_22 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_23 :
    ∀ offset : Fin 16,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_01_24 :
    ∀ offset : Fin 15,
      row 1
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_01 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 1 source = p13FeatureCompatibilityRow 1 source :=
      p13MultiScaleRows_featureAudit_01 source
    _ = semanticRow 1 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 1 source
