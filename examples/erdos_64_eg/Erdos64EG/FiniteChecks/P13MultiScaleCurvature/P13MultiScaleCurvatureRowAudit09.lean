...
private theorem p13MultiScaleRows_featureAudit_09_00 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 9
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_01 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_02 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_03 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_04 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_05 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_06 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_07 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_08 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_09 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_10 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_11 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_12 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_13 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_14 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_15 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_16 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_17 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_18 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_19 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_20 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_21 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_22 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_23 :
    ∀ offset : Fin 16,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_09_24 :
    ∀ offset : Fin 15,
      row 9
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_09 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 9 source = p13FeatureCompatibilityRow 9 source :=
      p13MultiScaleRows_featureAudit_09 source
    _ = semanticRow 9 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 9 source
