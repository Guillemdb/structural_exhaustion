...
private theorem p13MultiScaleRows_featureAudit_06_00 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 6
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_01 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_02 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_03 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_04 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_05 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_06 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_07 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_08 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_09 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_10 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_11 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_12 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_13 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_14 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_15 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_16 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_17 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_18 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_19 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_20 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_21 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_22 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_23 :
    ∀ offset : Fin 16,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_06_24 :
    ∀ offset : Fin 15,
      row 6
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_06 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 6 source = p13FeatureCompatibilityRow 6 source :=
      p13MultiScaleRows_featureAudit_06 source
    _ = semanticRow 6 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 6 source
