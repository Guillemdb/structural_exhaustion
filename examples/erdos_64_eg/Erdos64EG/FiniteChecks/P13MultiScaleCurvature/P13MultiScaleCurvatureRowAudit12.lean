...
private theorem p13MultiScaleRows_featureAudit_12_00 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 12
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_01 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_02 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_03 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_04 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_05 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_06 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_07 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_08 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_09 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_10 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_11 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_12 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_13 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_14 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_15 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_16 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_17 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_18 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_19 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_20 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_21 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_22 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_23 :
    ∀ offset : Fin 16,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_12_24 :
    ∀ offset : Fin 15,
      row 12
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_12 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 12 source = p13FeatureCompatibilityRow 12 source :=
      p13MultiScaleRows_featureAudit_12 source
    _ = semanticRow 12 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 12 source
