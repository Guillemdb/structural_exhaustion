...
private theorem p13MultiScaleRows_featureAudit_07_00 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 7
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_01 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_02 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_03 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_04 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_05 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_06 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_07 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_08 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_09 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_10 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_11 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_12 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_13 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_14 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_15 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_16 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_17 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_18 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_19 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_20 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_21 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_22 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_23 :
    ∀ offset : Fin 16,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_07_24 :
    ∀ offset : Fin 15,
      row 7
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_07 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 7 source = p13FeatureCompatibilityRow 7 source :=
      p13MultiScaleRows_featureAudit_07 source
    _ = semanticRow 7 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 7 source
