...
private theorem p13MultiScaleRows_featureAudit_11_00 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 11
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_01 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_02 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_03 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_04 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_05 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_06 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_07 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_08 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_09 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_10 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_11 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_12 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_13 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_14 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_15 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_16 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_17 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_18 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_19 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_20 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_21 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_22 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_23 :
    ∀ offset : Fin 16,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_11_24 :
    ∀ offset : Fin 15,
      row 11
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_11 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 11 source = p13FeatureCompatibilityRow 11 source :=
      p13MultiScaleRows_featureAudit_11 source
    _ = semanticRow 11 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 11 source
