...
private theorem p13MultiScaleRows_featureAudit_14_00 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 14
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_01 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_02 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_03 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_04 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_05 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_06 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_07 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_08 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_09 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_10 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_11 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_12 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_13 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_14 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_15 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_16 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_17 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_18 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_19 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_20 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_21 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_22 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_23 :
    ∀ offset : Fin 16,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_14_24 :
    ∀ offset : Fin 15,
      row 14
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_14 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 14 source = p13FeatureCompatibilityRow 14 source :=
      p13MultiScaleRows_featureAudit_14 source
    _ = semanticRow 14 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 14 source
