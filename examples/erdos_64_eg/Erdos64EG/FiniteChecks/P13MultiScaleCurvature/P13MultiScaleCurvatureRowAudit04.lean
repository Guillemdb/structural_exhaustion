...
private theorem p13MultiScaleRows_featureAudit_04_00 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 4
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_01 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_02 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_03 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_04 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_05 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_06 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_07 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_08 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_09 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_10 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_11 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_12 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_13 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_14 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_15 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_16 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_17 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_18 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_19 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_20 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_21 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_22 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_23 :
    ∀ offset : Fin 16,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_04_24 :
    ∀ offset : Fin 15,
      row 4
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_04 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 4 source = p13FeatureCompatibilityRow 4 source :=
      p13MultiScaleRows_featureAudit_04 source
    _ = semanticRow 4 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 4 source
