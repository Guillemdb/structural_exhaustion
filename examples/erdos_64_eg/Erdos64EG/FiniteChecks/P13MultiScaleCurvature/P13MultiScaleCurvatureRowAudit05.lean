...
private theorem p13MultiScaleRows_featureAudit_05_00 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 5
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_01 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_02 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_03 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_04 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_05 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_06 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_07 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_08 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_09 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_10 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_11 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_12 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_13 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_14 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_15 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_16 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_17 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_18 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_19 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_20 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_21 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_22 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_23 :
    ∀ offset : Fin 16,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_05_24 :
    ∀ offset : Fin 15,
      row 5
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_05 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 5 source = p13FeatureCompatibilityRow 5 source :=
      p13MultiScaleRows_featureAudit_05 source
    _ = semanticRow 5 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 5 source
