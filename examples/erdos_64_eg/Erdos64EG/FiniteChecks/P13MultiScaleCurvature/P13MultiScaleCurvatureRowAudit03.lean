...
private theorem p13MultiScaleRows_featureAudit_03_00 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) =
        p13FeatureCompatibilityRow 3
          (Core.FiniteBitRelationBarrier.intervalIndex
            0 16 (by decide) offset) := by
  native_decide

set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_01 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_02 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_03 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_04 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_05 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_06 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_07 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_08 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_09 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_10 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_11 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_12 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_13 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_14 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_15 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_16 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_17 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_18 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_19 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_20 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_21 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_22 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_23 :
    ∀ offset : Fin 16,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
set_option exponentiation.threshold 512 in
private theorem p13MultiScaleRows_featureAudit_03_24 :
    ∀ offset : Fin 15,
      row 3
          (Core.FiniteBitRelationBarrier.intervalIndex
...
theorem p13MultiScaleRows_rowAudit_03 : ∀ source : Fin 399,
  ...
  intro source
  calc
    row 3 source = p13FeatureCompatibilityRow 3 source :=
      p13MultiScaleRows_featureAudit_03 source
    _ = semanticRow 3 source :=
      p13FeatureCompatibilityRow_eq_semanticRow 3 source
