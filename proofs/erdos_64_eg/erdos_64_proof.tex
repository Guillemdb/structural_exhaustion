...
missing.  Likewise, node~[54] proves the local contradiction once the
node-[53] small-edge capacity inequality is available, but that capacity
producer is still missing.  These are proof obligations, not additional
manuscript branches.
\end{proof}
...
current Lean producer remains yellow until the exact legacy carrier input is
